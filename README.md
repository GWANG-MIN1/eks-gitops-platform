...
> **상태: 🚧 진행 중 — 만드는 과정을 공개로 기록합니다.**
> 학습이 우선인 인프라 프로젝트입니다. 아래 구조는 *목표(target)* 아키텍처이고,
> 각 부분은 단계별로 구현해 나가고 있습니다 ([docs/roadmap.md](docs/roadmap.md) 참고).
> 완성됐다고 주장하지 않습니다 — 설계와 만드는 과정을 정직하게 보여주는 게 목적입니다.
